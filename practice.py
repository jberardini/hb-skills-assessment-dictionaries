...
def without_duplicates(words):
    ...
    without_duplicates = sorted(set(words))
    without_duplicates = list(without_duplicates)
...
def top_chars(phrase):
    ...
    list_values = common_characters.values()
    most_occurences = max(list_values)

    most_common_character = []

    for char, occurences in common_characters.items():
